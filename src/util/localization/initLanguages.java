...
public class initLanguages {
	...
	public initLanguages(EKitaManager app) {
		this.app = app;
	}
	...
	public boolean initiateLanguages() {
		...
		german.setGraphic(new ImageView(new Image(EKitaManager.getInstance().getClass().getResourceAsStream("/resources/icons/flags/DE.png"))));
		MenuItem english = new MenuItem("English");		
		english.setGraphic(new ImageView(new Image(EKitaManager.getInstance().getClass().getResourceAsStream("/resources/icons/flags/GB.png"))));
		MenuItem french = new MenuItem("Français");		
		french.setGraphic(new ImageView(new Image(EKitaManager.getInstance().getClass().getResourceAsStream("/resources/icons/flags/FR.png"))));
